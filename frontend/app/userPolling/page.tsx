...
function SurveyContent() {
  ...
  const [answers, setAnswers] = useState<Array<{ questionId: string; answerId: string }>>([])
  ...
  const updateMetadata = (title: string, description: string) => {
    ...
    document.title = `${title} | نظام الاستطلاعات`;
  ...
  useEffect(() => {
    const loadPoll = async () => {
      ...
      try {
        ...
        // Update metadata with poll title and description
        if (response.poll?.title) {
          const pollTitle = response.poll.title;
          const pollDescription = response.poll.description || "صفحة المشاركة في الاستطلاعات وتقديم الإجابات";
          updateMetadata(pollTitle, pollDescription);
        }
  ...
  const progress: { [key in StepType]: number } = {
    1: 25,
    2: 50,
    3: 100,
  }
  ...
  const handleNext = async () => {
    if (step === 3) {
      ...
      if (!formData.teaching.trim()) {
        errors.teaching = "الرجاء إدخال المستوى التعليمي"
      }
                    ...
                    <div className="bg-white rounded-lg p-6 shadow-sm relative z-10">
                      <h2 className="text-2xl font-bold text-[#1e1e2d] mb-6 text-right flex items-center justify-end gap-2">
                        ...
                        <div className="bg-[#009688] text-white p-1.5 rounded-md">
                          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M19 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                        </div>
                      </h2>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-3 transition-all duration-300 hover:shadow-md p-4 rounded-xl border border-transparent hover:border-[#009688]/20">
                          <Label htmlFor="name" className="block text-right mb-2 text-lg font-medium flex items-center gap-2 justify-end text-[#1e1e2d]">
                            <div className="bg-[#009688] text-white p-1 rounded-md">
                              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                            </div>
                            الاسم
                          </Label>
                          <Input 
                            ...
                            className={`text-right border-2 ${formErrors.name ? 'border-red-500' : 'focus:border-[#009688]'} transition-all p-3 rounded-lg shadow-sm focus:shadow-md`}
                            placeholder="أدخل اسمك الكامل"
                          />
                          {formErrors.name && (
                            <div className="text-red-500 text-sm mt-2">{formErrors.name}</div>
                          )}
                        </div>
                        ...
                        <div className="space-y-3 transition-all duration-300 hover:shadow-md p-4 rounded-xl border border-transparent hover:border-[#009688]/20">
                          ...
                          <Input 
                            ...
                            onChange={handleInputChange} 
                            className={`text-right border-2 ${formErrors.email ? 'border-red-500' : 'focus:border-[#009688]'} transition-all p-3 rounded-lg shadow-sm focus:shadow-md`}
                            placeholder="أدخل بريدك الإلكتروني"
                          />
                          {formErrors.email && (
                            <div className="text-red-500 text-sm mt-2">{formErrors.email}</div>
                          )}
                        </div>
                      </div>
                      ...
                      <div className="mt-6 space-y-3 transition-all duration-300 hover:shadow-md p-4 rounded-xl border border-transparent hover:border-[#009688]/20">
                        ...
                        <Input 
                          ...
                          onChange={handleInputChange} 
                          className={`text-right border-2 ${formErrors.teaching ? 'border-red-500' : 'focus:border-[#009688]'} transition-all p-3 rounded-lg shadow-sm focus:shadow-md`}
                          placeholder="أدخل مستواك التعليمي"
                        />
                        {formErrors.teaching && (
                          <div className="text-red-500 text-sm mt-2">{formErrors.teaching}</div>
                        )}
                      </div>
                      ...
                      <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-3 transition-all duration-300 hover:shadow-md p-4 rounded-xl border border-transparent hover:border-[#009688]/20">
                          <Label htmlFor="address" className="block text-right mb-2 text-lg font-medium flex items-center gap-2 justify-end text-[#1e1e2d]">
                            <div className="bg-[#009688] text-white p-1 rounded-md">
                              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path><circle cx="12" cy="10" r="3"></circle><line x1="20" y1="8" x2="20" y2="14"></line><line x1="23" y1="11" x2="17" y2="11"></line></svg>
                            </div>
                            عنوان السكن
                          </Label>
                          <Input 
                            ...
                            onChange={handleInputChange} 
                            className={`text-right border-2 ${formErrors.address ? 'border-red-500' : 'focus:border-[#009688]'} transition-all p-3 rounded-lg shadow-sm focus:shadow-md`}
                            placeholder="أدخل عنوان سكنك"
                          />
                          {formErrors.address && (
                            <div className="text-red-500 text-sm mt-2">{formErrors.address}</div>
                          )}
                        </div>
                        ...
                        <div className="space-y-3 transition-all duration-300 hover:shadow-md p-4 rounded-xl border border-transparent hover:border-[#009688]/20">
                          ...
                          <Input
                            ...
                            onChange={handleInputChange}
                            className={`text-right border-2 ${formErrors.date_of_birth ? 'border-red-500' : 'focus:border-[#009688]'} transition-all p-3 rounded-lg shadow-sm focus:shadow-md`}
                          />
                          {formErrors.date_of_birth && (
                            <div className="text-red-500 text-sm mt-2">{formErrors.date_of_birth}</div>
                          )}
                        </div>
                      </div>
              ...
              {step === 2 && (
                <div className="space-y-8" dir="rtl">
                  {formErrors.questions && (
                    <div className="bg-red-50 text-red-600 p-4 rounded-lg mb-6 flex items-center gap-3 justify-end">
                      ...
                      <div className="bg-white p-6 rounded-lg shadow-sm relative z-10">
                        ...
                        <div className="w-full bg-gray-200 h-2 mb-6 rounded-full overflow-hidden">
                          <div 
                            ...
                            style={{ width: `${(answers.find(a => a.questionId === question._id) ? 100 : 0)}%` }}
                          ></div>
                        </div>
                        
                        <RadioGroup 
                          value={answers.find(a => a.questionId === question._id)?.answerId || ""}
                        ...
                        >
                          {question.answers.map((answer) => (
                            <div 
                              key={answer._id ?? `answer-${Math.random()}`} 
                              className={`flex items-center gap-3 p-4 rounded-lg border-2 transition-all ${
                                answers.find(a => a.questionId === question._id)?.answerId === answer._id 
                            ...
                            >
                              <RadioGroupItem
                                value={answer._id ?? ""}
                                id={`q${question._id}-option-${answer._id ?? ''}`}
                                className="text-[#009688]"
                              />
                              <Label 
                                htmlFor={`q${question._id}-option-${answer._id ?? ''}`}
